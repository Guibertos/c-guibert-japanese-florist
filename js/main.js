...
// --- services --- //
    ...
    $(function(){
        $('.scroll-right').on('click',function(){
            $('.page-f').addClass('animated slideInRight');
            $('.page-g').css('display', 'flex');
            $('.page-f').css('display', 'none');
        });

        $('.scroll-back').on('click', function(){
            $('.page-g').addClass('animated slideInLeft');
